              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-52">
                  ...
                  <DropdownMenuItem onClick={() => setTheme('hijau')} className="cursor-pointer">
                    <span className="h-4 w-4 rounded-full mr-2 bg-gradient-to-br from-teal-300 to-teal-500 border border-teal-600/30" />
                    <span className="flex-1">Hijau Tosca</span>
                  ...
                  {(['super', 'kuat', 'sedang', 'netral', 'kontras'] as const).map((i) => (
